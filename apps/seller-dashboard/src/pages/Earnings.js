...
const Earnings = () => {
  ...
  const { earnings = {}, payoutAccount = {}, payoutLedger = [], organization = {} } = data || {};
          ...
          <div className="card-body">
            {payoutAccount.bankName ? (
              ...
              <div className="no-bank-alert">
                <p>⚠️ No bank details found. Please update settlement settings in your Shop Profile immediately to enable order payouts.</p>
              </div>
            )}
          </div>
        </div>
