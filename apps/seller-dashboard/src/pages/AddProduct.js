...
const AddProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Construct image payload if URL provided
    ...
    try {
      ...
      alert('Product created successfully as a Draft. It will be live once reviewed!');
      navigate('/products');
    } catch (error) {
      setErrorMsg(error.response?.data?.message || error.message || 'Error creating product.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="product-form-container">
      <div className="form-header">
        ...
        <p>List a new item in the marketplace catalog. New items are saved as drafts for review.</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="product-form">
          <div className="form-row-grid">
            ...
            <div className="form-field full-width">
              ...
              <textarea 
                ...
                required 
                rows="5"
                placeholder="Describe key details, ingredients, net weight, packaging, organic certification details..." 
          ...
          <div className="form-actions-row">
            ...
            <button 
              ...
              disabled={loading}
            >
              {loading ? 'Saving Draft...' : 'Save Product Draft'}
            </button>
          </div>
        </form>
      </div>
