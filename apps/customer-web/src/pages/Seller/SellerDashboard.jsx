      ...
      <div className="main-dashboard-grid">
        ...
        <div className="dashboard-card">
          <div className="card-header">
            ...
            <Link to="/seller/orders" className="view-all-link">View All <FaArrowRight /></Link>
          </div>
        ...
        <div className="dashboard-card">
          <div className="card-header">
            ...
            <Link to="/seller/products" className="view-all-link">Manage Stock <FaArrowRight /></Link>
          </div>
          <div className="card-body">
